...
class Human36MMultiViewDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.root = root
        self.labels_path = labels_path  # 'data/h36m_train.pkl'
        self.image_shape = None if image_shape is None else tuple(image_shape)  # (192,256)
        self.test = test
        self.scale_bbox = scale_bbox
        self.norm_image = norm_image
        self.cuboid_size = cuboid_size
        ...
        with open(labels_path, 'rb') as f:
            self.labels = pickle.loads(f.read())    # List[Dict]. len=1559752. element dict keys: dict_keys(['image', 'joints_2d_gt', 'joints_2d_cpn', 'joints_2d_hrnet', 'joints_3d', 
                                                    #                                                        'joints_vis', 'video_id', 'image_id', 'subject', 'action', 'subaction', 'camera_id', 
                                                    #                                                        'source', 'camera', 'center', 'scale', 'box', 
                                                    #                                                        'joints_2d_gt_crop', 'joints_2d_cpn_crop', 'joints_2d_hrnet_crop'])
